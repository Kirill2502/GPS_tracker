package com.example.gpstracker.presentation.utils
...
object DialogManager {
    ...
    fun showSaveDialog(
        ...
        binding.apply {
            tvTimeD.text = "Время: $time"
            tvSpeed.text = "Скорость: $speed км/ч"
            tvDistanceD.text = "Дистанция: ${String.format("%.1f",distance.toFloatOrNull() ?: 0f)} м"
            bSave.setOnClickListener {
                listener.onClick()
                dialog.dismiss()
            }
